...
class Menu {
    ...
    public static int getRowCount() { return Menu.rowCount; }
    public static int getColCount() { return Menu.colCount; }
    ...
    public void objCollision(Menu oglobj) {
